<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 m-8">
        <div class="mx-4">
            <div class="px-2 text-black dark:text-white">
                <h1>{{ __('Bonjour , ' . Auth::user()->name) }}</h1>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-2 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mx-8 my-2">
            <div class="overflow-hidden shadow-sm rounded-lg p-6" style="background-color: #ed6a06">
                <a href="#" x-data="" x-on:click.prevent="$dispatch('open-modal', 'topup-modal')">
                    <div class="text-white text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 block my-4">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mx-8 my-2">
            <div class="overflow-hidden shadow-sm rounded-lg p-6" style="background-color: #d4d44d">
    ...
    <div class="grid grid-cols-2 gap-2 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mx-8 my-2">
            <div class="overflow-hidden shadow-sm rounded-lg p-6" style="background-color: #845223">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mx-8 my-2">
            <div class="overflow-hidden shadow-sm rounded-lg p-6" style="background-color: #008638">
